...
console.log(meyveler[0]); // İlk elemanı Elma 
console.log(meyveler[meyveler.length - 1]); // Çilek


// 4- Elma dizinin bir elemanımıdır?
console.log(meyveler.includes("Elma")); // elma meyveler dizisinde var mı araması yapıyoruz. varsa true yoksa false cevabını alırız.
console.log(meyveler.indexOf("Elma")); // indexof ile de arayabiliriz. -1'den büyük bir değer dönerse vardır.
