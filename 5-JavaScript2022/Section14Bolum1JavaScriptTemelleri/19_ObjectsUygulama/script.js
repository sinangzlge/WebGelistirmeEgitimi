...
let siparislertoplam = siparis1_toplam + siparis2_toplam;

console.log("sipariş 1 : " + siparis1_toplam);
console.log("sipariş 2 : " + siparis2_toplam);

console.log("Toplam ödenen miktar : " + siparislertoplam);


// sipariş objectlerini tek bir dizi içerisinde tanımladık.
