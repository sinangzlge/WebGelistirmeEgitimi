...
let sayilar = [1,5,7,15,3,25,12,24,50];
...
let ogrenciler = [
    ...
    {"ad":"çınar","soyad":"turan","notlar":[15,20,60]},
];
    ...
    for(let ogrenci of ogrenciler){
        ...
        console.log(`${ogrenci.ad} ${ogrenci.soyad} isimli öğrencinin not ortalaması : ${ortalama.toFixed(2)}'dır.`);
